...
public static partial class Noise
{
    ...
    public struct Voronoi1D<L,D,F> : INoise where L : struct, ILattice where F : struct, IVoronoiFunction where D : struct, IVoronoiDistance
    {
    ...
    public struct Voronoi2D<L,D,F> : INoise where L : struct, ILattice where F : struct, IVoronoiFunction where D : struct, IVoronoiDistance
    {
    ...
    public struct Voronoi3D<L,D,F> : INoise where L : struct, ILattice where F : struct, IVoronoiFunction where D : struct, IVoronoiDistance
    {
