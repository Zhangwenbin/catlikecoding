...
// 
//y=asin(2πp(d−st))
//where d is the distance to the wave origin, a is the wave amplitude, p is its period, s is its speed, and t is the time.

//求解法线步骤
//先求导数,链式求导
//再求×积 calculate  Z×X  Z=float3(0.0, derivatives.y, 1.0) X=float3(1.0, derivatives.x, 0.0)
//结果就是法线
